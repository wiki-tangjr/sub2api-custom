...
func RegisterUserRoutes(
	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		user := authenticated.Group("/user")
		{
			...
			user.GET("/aff/agents", h.User.GetAffiliateAgents)
			user.POST("/aff/agents/set", h.User.SetAffiliateSubAgent)
			user.PUT("/aff/invitees/:user_id/hide", h.User.SetInviteeAffiliateHidden)
