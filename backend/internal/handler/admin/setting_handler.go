...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		TelegramEntryLabel:                                     settings.TelegramEntryLabel,
		...
		PaymentRechargeNotice:                                  paymentCfg.RechargeNotice,
		PaymentSubscriptionNotice:                              paymentCfg.SubscriptionNotice,
		PaymentSubscriptionPlansPerRow:                         paymentCfg.SubscriptionPlansPerRow,
		PaymentRechargeQuickAmounts:                            service.FormatRechargeQuickAmounts(paymentCfg.RechargeQuickAmounts),
		PaymentRechargeDiscountTiers:                           service.FormatRechargeDiscountTiers(paymentCfg.RechargeDiscountTiers),
