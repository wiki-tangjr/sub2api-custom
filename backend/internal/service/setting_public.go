...
func (s *SettingService) GetPublicSettings(ctx context.Context) (*PublicSettings, error) {
	keys := []string{
		...
		// 魔改 #12: 客服板块标题/描述/样式与入口文案必须一起公开，否则后台设置了前台读不到
		SettingKeyContactSectionTitle,
		SettingKeyContactSectionDescription,
		SettingKeyTelegramEntryLabel,
		SettingKeyWeChatGroupEntryLabel,
		SettingKeyWeChatContactEntryLabel,
		SettingKeyContactSectionStyle,
		SettingKeyDocURL,
