...
func (r *paymentFulfillmentAffiliateRepoStub) SetUserRebateCycle(context.Context, int64, *int, *int, bool, bool) error {
	panic("unexpected SetUserRebateCycle call")
}

func (r *paymentFulfillmentAffiliateRepoStub) SetHideAffiliateForInvitees(context.Context, int64, bool) error {
...
func (r *paymentFulfillmentAffiliateRepoStub) IsAffiliateHiddenByInviter(context.Context, int64) (bool, error) {
	return false, nil
}
