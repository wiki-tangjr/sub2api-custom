  ...
  <AppLayout>
      ...
      <template #filters>
        <div class="flex flex-col gap-3">
          <div class="flex flex-col justify-between gap-3 lg:flex-row lg:items-start">
            ...
            <div class="flex flex-shrink-0 justify-end gap-3">
              <button
                @click="loadApiKeys"
                :disabled="loading"
    ...
    <Teleport to="body">
      <div
        ...
        ref="dropdownRef"
        class="animate-in fade-in slide-in-from-top-2 fixed z-[100000020] w-max min-w-[min(92vw,380px)] max-w-[calc(100vw-16px)] overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5 duration-200 sm:min-w-[380px] dark:bg-dark-800 dark:ring-white/10"
