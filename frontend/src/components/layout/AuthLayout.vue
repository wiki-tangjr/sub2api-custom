<template>
  <div class="relative flex min-h-screen flex-col overflow-x-clip p-4">
    <!-- Background -->
    <div
    ...
    <div class="relative z-10 mx-auto w-full max-w-md shrink-0 space-y-2.5 pb-2 pt-6 text-center">
      ...
      <div class="flex flex-wrap items-center justify-center gap-2">
          <a
            ...
            class="group inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-full border border-gray-200/70 bg-white/80 px-3 py-1 text-xs text-gray-400 transition-all duration-200 hover:border-primary-300 hover:text-primary-600 dark:border-dark-700/70 dark:bg-dark-800/70 dark:text-dark-500 dark:hover:border-primary-500/60 dark:hover:text-primary-400"
          >
            <svg
