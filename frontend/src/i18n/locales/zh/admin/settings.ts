    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            title: '专属用户配置',
            description: '为指定用户设置专属邀请码、返利比例、冻结期、有效期或隐藏其邀请用户的邀请返利入口。仅展示已设置过专属配置的用户。',
            addButton: '添加专属用户',
            ...
            hidden: '隐藏',
            agentLevelNone: '普通用户',
            agentLevelFirst: '一级代理',
            agentLevelSecond: '二级代理',
            fullEmailBadge: '完整邮箱',
            selfHiddenBadge: '自身返利隐藏',
            resetTitle: '重置该用户的专属配置',
            resetMessage: '确认将 {email} 的专属配置全部重置为默认？\n• 专属返利比例、冻结期、有效期将清除（沿用全局）\n• 邀请来的用户将恢复显示邀请返利入口\n• 邀请码将重新生成为系统随机码（已分发的旧邀请链接将失效）',
          ...
          modal: {
            ...
            freezeLabel: '专属冻结期（小时，可选）',
            freezePlaceholder: '例如 24',
            freezeHint: '0-720 小时；留空（编辑模式下）表示清除专属冻结期并沿用全局。',
            durationLabel: '专属有效期（天，可选）',
            durationPlaceholder: '例如 30',
            durationHint: '0-3650 天；0 表示永久；留空（编辑模式下）表示清除专属有效期并沿用全局。',
            hideInviteesLabel: '隐藏该用户邀请来的账号里的邀请返利',
            hideInviteesHint: '开启后，被该用户邀请来的账号仍绑定原邀请码，但看不到也不能访问邀请返利功能，避免继续发展下级。',
            agentLevelLabel: '代理商等级',
            agentLevelHint: '一级代理可在自己的邀请返利页面发展二级代理并设置返利比例；二级代理必须指定所属一级代理。',
            agentParentLabel: '所属一级代理用户 ID',
            agentParentPlaceholder: '例如 123',
            agentParentHint: '二级代理的上级必须是一级代理；二级代理的返利比例由上级设置且不能超过上级。',
            agentParentInvalid: '请输入有效的所属一级代理用户 ID',
            showFullEmailLabel: '允许该用户查看邀请人完整邮箱',
            showFullEmailHint: '开启后，该用户的邀请返利页面中，其邀请用户的邮箱不再打码（默认关闭，保持现有打码展示）。',
            hideSelfLabel: '隐藏该账号自身的邀请返利入口',
            hideSelfHint: '开启后，该账号登录后看不到邀请返利入口，也无法继续发展下级。',
            errorEmpty: '至少填写一项：专属邀请码、专属返利比例、专属冻结期、专属有效期、隐藏下级返利、代理商等级或邮箱策略',
            errorBadRate: '请输入 0-100 之间的比例',
            errorBadFreeze: '请输入 0-720 之间的整数小时',
            errorBadDuration: '请输入 0-3650 之间的整数天数',
          },
          batchModal: {
      ...
      site: {
        ...
        telegramGroupUrl: 'Telegram 群组链接',
        telegramGroupUrlPlaceholder: 'https://t.me/your_group',
        telegramGroupUrlHint: '填写后将在用户端显示群组入口，并在新标签页打开。',
        wechatGroupQrCode: '微信群二维码',
        wechatGroupQrCodeHint: '上传微信群二维码图片，用户点击入口后扫码加入。',
        contactSectionConfig: '客服板块展示配置',
        contactSectionTitle: '板块标题',
        contactSectionTitlePlaceholder: '联系客服',
        contactSectionTitleHint: '留空时默认显示“联系客服”。',
        contactSectionStyle: '展示样式',
        contactStyleCard: '卡片式（图标+按钮）',
        contactStyleList: '列表式（文字链接）',
        contactSectionStyleHint: '卡片式更醒目，适合作为主要联系入口；列表式更紧凑。',
        contactSectionDescription: '板块描述',
        contactSectionDescriptionPlaceholder: '遇到问题？加入我们的群组获取实时帮助',
        contactSectionDescriptionHint: '显示在标题下方的说明文案，留空则不显示。',
        telegramEntryLabel: 'Telegram 入口文案',
        telegramEntryLabelPlaceholder: '加入 Telegram 群组',
        telegramEntryLabelHint: '用户点击后新标签页打开 Telegram 群组。',
        wechatGroupEntryLabel: '微信群入口文案',
        wechatGroupEntryLabelPlaceholder: '扫码加入微信群',
        wechatGroupEntryLabelHint: '用户点击后弹出二维码供扫码。',
        ...
        contactEntries: {
          ...
          empty: '还没有联系方式，点击下方按钮添加。',
          untitled: '未命名条目',
          moveUp: '上移',
          moveDown: '下移',
          label: '展示名称',
          labelPlaceholder: '例如：加入 Telegram 群组',
          type: '类型',
          typeLink: '链接（点击跳转）',
          typeQrcode: '二维码（扫码）',
          typeText: '文本（微信号等，可复制）',
          iconType: '图标类型',
          iconTypeEmoji: 'Emoji 图标',
          iconTypeImage: '自定义图片',
          display: '展示方式',
          displayModal: '弹窗展示（点击后弹出）',
          displayHover: '鼠标悬停展示',
          displayInline: '直接内联展示',
          displayModalHint: '点击图标后弹出对话框，适合二维码、长文本。',
          displayHoverHint: '鼠标移上去就显示卡片，适合群链接、微信号；手机端会自动回退为点击弹窗。',
          displayInlineHint: '图标直接平铺在页面上，适合数量少、希望一目了然的入口。',
          group: '分组（可选）',
          groupPlaceholder: '例如：官方群组',
          groupHint: '同名且相邻的条目会在前台聚成一组并显示小标题；留空则不分组。',
          preview: '预览',
          previewTitle: '前台效果预览',
          previewHint: '仅预览已启用条目',
          qrHint: '建议上传方形、边界清晰的二维码图片（最大 2MB）。',
          valueHint: '展示后用户可一键复制该内容。',
          openTargetHint: '仅对链接类型生效。',
          icon: '图标',
          iconPlaceholder: '💬',
          url: '链接地址',
          openTarget: '打开方式',
          openNewTab: '新标签页打开',
          openCurrentTab: '当前标签页打开',
          qrCode: '二维码图片',
          value: '文本内容',
          valuePlaceholder: '例如：wechat_id_123',
          description: '补充说明（可选）',
          descriptionPlaceholder: '显示在弹窗/悬停卡片中的说明文字',
          add: '添加联系方式',
          newLabel: '新联系方式',
        },
        docUrl: '文档链接',
      ...
      customMenu: {
        title: '自定义菜单页面',
        description: '添加自定义页面到侧边栏导航，支持内嵌 iframe 或新标签页打开。每个页面可以设置为普通用户或管理员可见。',
        itemLabel: '菜单项 #{n}',
        name: '菜单名称',
        ...
        visibilityAdmin: '管理员',
        openMode: '打开方式',
        openModeIframe: '页面内嵌（iframe）',
        openModeNewTab: '新标签页跳转',
        openModeHint: '选择“新标签页跳转”后，点击侧边栏菜单会直接在浏览器新标签页打开该链接。',
        add: '添加菜单项',
        remove: '删除',
        moveUp: '上移',
        moveDown: '下移',
      ...
      payment: {
        ...
        rechargeNotice: '充值页公告',
        rechargeNoticePlaceholder: '例如：需要开发票请联系客服 / 退款说明...（支持 Markdown）',
        rechargeNoticeHint: '留空则不显示；支持 Markdown 语法，仅展示在充值页。',
        subscriptionNotice: '订阅页公告',
        subscriptionNoticePlaceholder: '例如：订阅套餐说明、续费提醒...（支持 Markdown）',
        subscriptionNoticeHint: '留空则不显示；支持 Markdown 语法，仅展示在订阅页。',
        plansPerRow: '每排套餐数量',
        plansPerRowHint: '订阅套餐在桌面端一排展示几个（1-6，默认 3）。手机端始终单列自适应。',
        quickAmounts: '快捷充值金额',
        quickAmountsPlaceholder: '例如：10,50,100,200,500（留空使用默认）',
        quickAmountsHint: '用逗号分隔，最多 24 个。留空则沿用系统默认按钮，前台页面保持原样。',
        discountTiers: '充值阶梯优惠',
        discountTiersPlaceholder: '例如：100:2,500:3,1000:5',
        discountTiersHint: '设置“多少钱到多少钱优惠多少”，最多 24 档。例如起始 500、结束 1000、优惠 5%。结束金额留空表示无上限。留空表示不开启。优惠只减少本次实付金额，到账额度不变；判定基于订单真实金额，前台自定义输入无法绕过。',
        noticeSectionTitle: '页面公告',
        noticeSectionHint: '留空即不展示，前台保持原样；支持 Markdown 语法。',
        discountSectionHint: '留空则沿用系统默认按钮 / 不开启优惠，前台保持原样。',
        removeItem: '删除',
        clearAll: '清空全部',
        addAmount: '添加金额',
        addTier: '添加优惠档位',
        quickAmountsEmpty: '尚未配置快捷金额，前台将继续使用系统默认按钮。',
        quickAmountsAddPlaceholder: '输入金额后回车，例如 100',
        quickAmountsInvalid: '请输入大于 0 的数字。',
        quickAmountsPresets: '快速添加常用金额',
        discountTiersEmpty: '尚未配置优惠档位，前台不显示任何优惠。',
        discountTiersUnlimitedHint: '结束金额留空 = 无上限（满此金额起一直优惠）。',
        discountTiersAdvanced: '高级：直接编辑原始配置',
        discountTiersAdvancedHint: '格式为“起始金额-结束金额:优惠百分比”，结束金额留空表示无上限。修改后点击输入框外生效。',
        tierMin: '起始金额',
        tierMinPlaceholder: '不限',
        tierMax: '结束金额',
        tierMaxPlaceholder: '不限',
        tierPercent: '优惠',
        tierPercentPlaceholder: '2',
        tierPercentError: '优惠百分比需大于 0 且小于 100。',
        tierMaxError: '结束金额需大于 0，或留空表示无上限。',
        tierRangeRequired: '起始金额与结束金额不能同时留空。',
        tierRangeError: '结束金额不能小于起始金额。',
        tierSummaryRange: '充值 {min} – {max} 元，优惠 {percent}%',
        tierSummaryMax: '充值不超过 {max} 元，优惠 {percent}%',
        tierSummaryMin: '充值满 {min} 元，优惠 {percent}%',
        discountTitle: '充值档位与阶梯优惠',
        providerEasypay: '易支付',
