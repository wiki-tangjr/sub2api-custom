export default {
  ...
  affiliate: {
    ...
    agents: {
      title: '我的下级代理',
      description: '管理你直接邀请的用户：可设置二级代理、设置返利比例、单独开关对方的邀请返利功能',
      rateHint: '你的返利比例上限：{rate}',
      rateLabel: '当前返利比例',
      rateInherited: '跟随全局',
      levelNormal: '普通用户',
      levelTwo: '二级代理',
      ...
      setSubAgent: '设为二级代理',
      editRate: '修改返利比例',
      cancelSubAgent: '取消二级代理',
      disableAffiliate: '关闭邀请返利',
      enableAffiliate: '开启邀请返利',
      disableSuccess: '已关闭该用户的邀请返利功能',
      enableSuccess: '已开启该用户的邀请返利功能',
      cancelSuccess: '已取消二级代理身份',
      saveSuccess: '二级代理设置已保存',
      saveFailed: '保存失败',
      rateInvalid: '返利比例必须在 0 到 {max} 之间',
      modalTitle: '设置二级代理',
      modalDescription: '为 {email} 设置二级代理返利比例',
      modalRateLabel: '二级代理返利比例（%）',
      modalRateHint: '不能超过你自身的返利比例 {max}',
      modalCancel: '取消',
      modalSave: '保存',
      modalSaving: '保存中...'
    },
