export default {
  common: {
    ...
    processing: '处理中...',
    contactSupport: '联系客服',
    contactSectionDefaultTitle: '联系客服',
    contactSectionDefaultDescription: '遇到问题？加入我们的群组，获取实时帮助',
    telegramGroup: '加入 Telegram 群组',
    wechatGroup: '扫码加入微信群',
    wechatContactDefault: '添加微信客服',
    wechatGroupQrCode: '微信群二维码',
    contactInvalidQrCode: '二维码地址无效，请联系站长重新配置',
    contactScanHint: '使用微信扫码加入',
    contactOpenLink: '打开链接',
    contactInvalidUrl: '链接地址无效，请联系站长重新配置',
    add: '添加',
