export default {
    settings: {
      ...
      payment: {
        ...
        discountTiersHint: 'Format is "top-up amount:discount percent", comma separated, up to 24 tiers. 100:2 means 2% off from 100. Leave empty to disable. The discount only reduces the amount charged; the credited balance is unchanged.',
