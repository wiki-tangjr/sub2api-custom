export default {
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          customUsers: {
            ...
            description: 'Set a custom invite code, rebate rate, freeze period, validity period, or hide affiliate access for users invited by specific users. Lists only users that have an override applied.',
            ...
            notHidden: 'shown',
            hidden: 'hidden',
            agentLevelNone: 'Regular user',
            agentLevelFirst: 'Level-1 agent',
            agentLevelSecond: 'Level-2 agent',
            fullEmailBadge: 'Full email',
            selfHiddenBadge: 'Self hidden',
            resetTitle: 'Reset Custom Settings',
            resetMessage: 'Reset all custom settings for {email}?\n• The exclusive rebate rate, freeze period, and validity period will be cleared (fall back to global settings)\n• Invited users will regain access to the affiliate page\n• The invite code will be regenerated as a new system code (previously shared links will stop working)',
            ...
            col: {
              ...
              freeze: 'Freeze',
              duration: 'Validity',
              hideInvitees: 'Hide Downline',
              agent: 'Agent / Email Policy',
              actions: 'Actions',
            },
          },
          modal: {
            ...
            freezeLabel: 'Exclusive Freeze Period (hours, optional)',
            freezePlaceholder: 'e.g. 24',
            freezeHint: '0-720 hours. Leave empty (in edit mode) to clear and fall back to global.',
            durationLabel: 'Exclusive Validity Period (days, optional)',
            durationPlaceholder: 'e.g. 30',
            durationHint: '0-3650 days; 0 means forever. Leave empty (in edit mode) to clear and fall back to global.',
            hideInviteesLabel: 'Hide affiliate access for users invited by this user',
            hideInviteesHint: 'When enabled, invited accounts stay bound to this invite code but cannot see or access affiliate/rebate features, preventing downstream invites.',
            agentLevelLabel: 'Agent Level',
            agentLevelHint: 'Level-1 agents can promote their own invitees to level-2 agents and set their rebate rate. Level-2 agents must have a level-1 parent.',
            agentParentLabel: 'Parent Level-1 Agent User ID',
            agentParentPlaceholder: 'e.g. 123',
            agentParentHint: 'A level-2 agent parent must be a level-1 agent. The level-2 rebate rate is set by the parent and cannot exceed the parent rate.',
            agentParentInvalid: 'Please enter a valid parent level-1 agent user ID',
            showFullEmailLabel: 'Allow this user to view full invitee emails',
            showFullEmailHint: 'When enabled, invitee emails on this user\'s affiliate page are shown unmasked. Disabled by default to preserve current masked display.',
            hideSelfLabel: 'Hide this account\'s own affiliate entry',
            hideSelfHint: 'When enabled, this account cannot see or access the affiliate page and cannot recruit downline.',
            errorEmpty: 'Fill at least one: custom invite code, rate, freeze period, validity period, hide downline, agent level, or email policy',
            errorBadRate: 'Please enter a number between 0 and 100',
            errorBadFreeze: 'Please enter an integer hour value between 0 and 720',
            errorBadDuration: 'Please enter an integer day value between 0 and 3650',
          },
          batchModal: {
      ...
      site: {
        ...
        telegramGroupUrlHint: 'When configured, users can open the group in a new tab.',
        wechatGroupQrCode: 'WeChat Group QR Code',
        wechatGroupQrCodeHint: 'Upload the WeChat group QR code image for users to scan.',
        contactSectionConfig: 'Contact Section Display Config',
        contactSectionTitle: 'Section Title',
        contactSectionTitlePlaceholder: 'Contact Support',
        contactSectionTitleHint: 'Leave empty to default to "Contact Support".',
        contactSectionStyle: 'Display Style',
        contactStyleCard: 'Card (icon + button)',
        contactStyleList: 'List (text links)',
        contactSectionStyleHint: 'Cards are more prominent; lists are more compact.',
        contactSectionDescription: 'Section Description',
        contactSectionDescriptionPlaceholder: 'Need help? Join our groups for real-time support',
        contactSectionDescriptionHint: 'Shown under the title. Empty hides it.',
        telegramEntryLabel: 'Telegram Entry Label',
        telegramEntryLabelPlaceholder: 'Join Telegram Group',
        telegramEntryLabelHint: 'Opens the Telegram group in a new tab.',
        wechatGroupEntryLabel: 'WeChat Group Entry Label',
        wechatGroupEntryLabelPlaceholder: 'Scan to Join WeChat Group',
        wechatGroupEntryLabelHint: 'Opens a QR code dialog for scanning.',
        ...
        contactEntries: {
          ...
          empty: 'No contact entries yet. Use the button below to add one.',
          untitled: 'Untitled entry',
          moveUp: 'Move up',
          moveDown: 'Move down',
          label: 'Label',
          labelPlaceholder: 'e.g. Join Telegram Group',
          type: 'Type',
          typeLink: 'Link (click to open)',
          typeQrcode: 'QR code (scan)',
          typeText: 'Text (WeChat ID etc., copyable)',
          iconType: 'Icon type',
          iconTypeEmoji: 'Emoji icon',
          iconTypeImage: 'Custom image',
          display: 'Display mode',
          displayModal: 'Modal (opens on click)',
          displayHover: 'Show on hover',
          displayInline: 'Inline (always visible)',
          displayModalHint: 'Opens a dialog when clicked. Best for QR codes and longer text.',
          displayHoverHint: 'Shows a card on hover. Best for group links and IDs; touch devices fall back to tap-to-open.',
          displayInlineHint: 'Renders directly on the page. Best when you only have a couple of entries.',
          group: 'Group (optional)',
          groupPlaceholder: 'e.g. Official groups',
          groupHint: 'Adjacent entries sharing the same group render together under a small heading. Leave empty for no grouping.',
          preview: 'Preview',
          previewTitle: 'Live front-end preview',
          previewHint: 'Enabled entries only',
          qrHint: 'Use a square QR image with clear edges (max 2MB).',
          valueHint: 'Users can copy this value with one click.',
          openTargetHint: 'Only applies to link entries.',
          icon: 'Icon',
          iconPlaceholder: '💬',
          url: 'URL',
          ...
          value: 'Text value',
          valuePlaceholder: 'e.g. wechat_id_123',
          description: 'Description (optional)',
          descriptionPlaceholder: 'Shown in the modal / hover card',
          add: 'Add contact entry',
          newLabel: 'New contact entry',
        },
      ...
      customMenu: {
        ...
        openMode: 'Open Mode',
        openModeIframe: 'Embed in page (iframe)',
        openModeNewTab: 'Open in new tab',
        openModeHint: 'When "Open in new tab" is selected, clicking the sidebar item opens the URL in a browser tab directly.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
      ...
      payment: {
        ...
        rechargeNoticePlaceholder: 'e.g. Contact support for invoices / refund policy... (Markdown supported)',
        rechargeNoticeHint: 'Leave empty to hide. Markdown supported; shown only on the top-up page.',
        subscriptionNotice: 'Subscription Page Notice',
        subscriptionNoticePlaceholder: 'e.g. Plan details, renewal reminders... (Markdown supported)',
        subscriptionNoticeHint: 'Leave empty to hide. Markdown supported; shown only on the subscription page.',
        plansPerRow: 'Plans Per Row',
        plansPerRowHint: 'How many subscription cards to show per row on desktop (1-6, default 3). Mobile stays single column.',
        quickAmounts: 'Quick Top-up Amounts',
        quickAmountsPlaceholder: 'e.g. 10,50,100,200,500 (leave empty for defaults)',
        quickAmountsHint: 'Comma separated, up to 24 values. Leave empty to keep the built-in buttons and the unchanged storefront.',
        discountTiers: 'Tiered Top-up Discount',
        discountTiersPlaceholder: 'e.g. 100:2,500:3,1000:5',
        discountTiersHint: 'Set "from amount - to amount => discount percent", up to 24 tiers. For example from 500 to 1000 with 5% off. Leave the end amount empty for no upper bound. Leave everything empty to disable. The discount only reduces the amount charged; the credited balance is unchanged, and it is decided from the real order amount so a hand-typed amount cannot bypass it.',
        noticeSectionTitle: 'Page Notices',
        noticeSectionHint: 'Leave empty to hide; the storefront stays unchanged. Markdown supported.',
        discountSectionHint: 'Leave empty to keep the built-in buttons and to disable discounts; the storefront stays unchanged.',
        removeItem: 'Remove',
        clearAll: 'Clear all',
        addAmount: 'Add amount',
        addTier: 'Add discount tier',
        quickAmountsEmpty: 'No quick amounts configured yet; the storefront keeps using the built-in buttons.',
        quickAmountsAddPlaceholder: 'Type an amount and press Enter, e.g. 100',
        quickAmountsInvalid: 'Enter a number greater than 0.',
        quickAmountsPresets: 'Quick add common amounts',
        discountTiersEmpty: 'No discount tiers configured; no discount is shown on the storefront.',
        discountTiersUnlimitedHint: 'Leave the end amount empty for no upper bound (discount applies from this amount upwards).',
        discountTiersAdvanced: 'Advanced: edit the raw configuration',
        discountTiersAdvancedHint: 'Format is "start-end:percent"; an empty end amount means no upper bound. Changes apply when the field loses focus.',
        tierMin: 'From',
        tierMinPlaceholder: 'No min',
        tierMax: 'To',
        tierMaxPlaceholder: 'No max',
        tierPercent: 'Discount',
        tierPercentPlaceholder: '2',
        tierPercentError: 'Discount percent must be greater than 0 and less than 100.',
        tierMaxError: 'The end amount must be greater than 0, or left empty for no upper bound.',
        tierRangeRequired: 'Start and end amounts cannot both be empty.',
        tierRangeError: 'The end amount cannot be smaller than the start amount.',
        tierSummaryRange: 'Top up {min} - {max}, get {percent}% off',
        tierSummaryMax: 'Top up up to {max}, get {percent}% off',
        tierSummaryMin: 'Top up at least {min}, get {percent}% off',
        discountTitle: 'Top-up Amounts & Tiered Discount',
