export default {
  ...
  affiliate: {
    ...
    agents: {
      title: 'My Sub-Agents',
      description: 'Manage users you invited directly: promote them to level-2 agents, set their rebate rate, and toggle their affiliate feature.',
      rateHint: 'Your rebate rate cap: {rate}',
      rateLabel: 'Current rate',
      rateInherited: 'Global default',
      levelNormal: 'Regular user',
      levelTwo: 'Level-2 agent',
      hidden: 'Affiliate disabled',
      empty: 'You have not invited any users yet',
      setSubAgent: 'Make level-2 agent',
      editRate: 'Edit rebate rate',
      cancelSubAgent: 'Remove agent',
      disableAffiliate: 'Disable affiliate',
      enableAffiliate: 'Enable affiliate',
      disableSuccess: 'Affiliate feature disabled for this user',
      enableSuccess: 'Affiliate feature enabled for this user',
      cancelSuccess: 'Level-2 agent removed',
      saveSuccess: 'Sub-agent settings saved',
      saveFailed: 'Failed to save',
      rateInvalid: 'Rebate rate must be between 0 and {max}',
      modalTitle: 'Set Sub-Agent',
      modalDescription: 'Set the level-2 rebate rate for {email}',
      modalRateLabel: 'Sub-agent rebate rate (%)',
      modalRateHint: 'Cannot exceed your own rebate rate of {max}',
      modalCancel: 'Cancel',
      modalSave: 'Save',
      modalSaving: 'Saving...'
    },
