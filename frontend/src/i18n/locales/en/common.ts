export default {
  common: {
    ...
    contactSectionDefaultTitle: 'Contact Support',
    contactSectionDefaultDescription: 'Need help? Join our groups for real-time support',
    telegramGroup: 'Join Telegram Group',
    wechatGroup: 'Scan to Join WeChat Group',
    wechatContactDefault: 'Add WeChat Contact',
    wechatGroupQrCode: 'WeChat Group QR Code',
    contactInvalidQrCode: 'Invalid QR code URL, please ask the site admin to reconfigure',
    contactScanHint: 'Scan with WeChat to join',
    contactOpenLink: 'Open link',
    contactInvalidUrl: 'Invalid link URL, please ask the site admin to reconfigure',
    add: 'Add',
